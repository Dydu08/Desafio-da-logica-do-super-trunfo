...
#include <string.h>
    ...
    int main(){
        ...
        printf("Agora você deve selecionar qual atributo deve duelar.\n");
        ...
        if(populacao1 > populacao2){
            ...
            printf("Resultado: As cartas 1 e 2 empataram no atributo população!\n");
        }
        break;
        ...
        if(area1 > area2){
            ...
            printf("Resultado: As cartas 1 e 2 empataram no atributo Área!\n");
        }
        break;
        ...
        if(pib1 > pib2){
            ...
            printf("Resultado: As cartas 1 e 2 empataram no atributo PIB!\n");
        }
        break;
        ...
        if(turismo1> turismo2){
            ...
            printf("Resultado: As cartas 1 e 2 empataram no atributo Número de Pontos Turísticos!\n");
        }
        break;
        ...
        if(dp1 < dp2){
            ...
            printf("Resultado: As cartas 1 e 2 empataram no atributo Densidade Populacional!\n");
        }
        break;
        ...
        if(pibpc1 > pibpc2){
            ...
            printf("Resultado: As cartas 1 e 2 empataram no atributo PIB per capital!\n");
        }
        break;
